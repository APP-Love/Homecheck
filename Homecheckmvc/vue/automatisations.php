            ...
            <div id="box"> 
                ...
                <div class="box3">
                        ...
                        <form class="table2" method="post" action="index.php?cible=piece" >
                            ...
                            <p> <input type="radio" name="salon" id="salon" class="td3"/> <label for="salon"> Salon </label><br/>
                                <input type="radio" name="chambre1" id="chambre1" class="td3"/> <label for="chambre1"> Chambre 1 </label><br/> 
                                <input type="radio" name="chambre2" id="chambre2" class="td3"/> <label for="chambre2"> Chambre 2 </label><br/>
                                <input type="radio" name="cuisine" id="cuisine" class="td3"/> <label for="cuisine"> Cuisine </label><br/>
                                <input type="radio" name="sdb1" id="sdb1" class="td3"/> <label for="sdb1"> Salle de bain 1 </label><br/>
                                <input type="radio" name="sdb2" id="sdb2" class="td3"/> <label for="sdb2"> Salle de bain 2 </label><br/>
                                <input type="radio" name="garage" id="garage" class="td3"/> <label for="garage"> Garage </label><br/>
                                <input type="radio" name="terrasse" id="terrasse" class="td3"/> <label for="terrasse"> Terrasse </label><br/>
                            </p>
                        </form>   
                        ...
                        <nav1>
                            <ul >
                                <form class="données" method="post" action="index.php?cible=retour" >
