    ...
    ?>
        <div class="rectangle1">
                <div class="rectangle2">
                    ...
                    <div class="langues">
                    <a href="?" > <img class="francais" name="fr" src="image/francais.gif" type="Français" alt="Français" /></a>
                    <a href="?" > <img class="anglais" name="eng" src="image/anglais.gif"  type="Anglais" alt="English" /></a>
                    </div>
                </div>
            </div>
    <?php
       ...
       <div class="rectangle1">
                <div class="rectangle2">
                    ...
                    <div id="Admin">
                        ...
                        <a href="index.php?cible=deco" ><img class="deco" src="image/deconnexion.png" type="Déconnexion" alt="Disconnection"></a>
                    </div>
                    <div class="langues">
                ...
                <div class=" rectangle3">
                    <table class="menu"> 
                        <tr class="tr2">
                            <td class="td2" onclick="location='index.php?cible=accueilco'" style="cursor:pointer" > About Homecheck </td>
                            <td class="td2" onclick="location= 'index.php?cible=meslogements'" style="cursor:pointer" > My accomodation </td>
                            <td class="td2" onclick="location='index.php?cible=monprofil'" style="cursor:pointer">  
                            My profil </td>
                            <td class="td2" onclick="location='index.php?cible=contactez'" style="cursor:pointer"> Contact us</td>
                        </tr>
                    </table>
