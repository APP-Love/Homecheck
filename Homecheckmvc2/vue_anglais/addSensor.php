...
require "common.php";
 ...
 <a href="index2.php?cible=capteursparpiece"> <img class="croix2" src="image/croix2.png" alt="fermeture" /> </a>
        ...
        <div class="formulaire2">
                ...
                <div class="reference">
                             ...
                             <p>
                         <label>Reference of the sensor <br/> </label>  <br/> <input type="text"  id="pseudo" name="pseudo" placeholder="Numéro de série..."/><br/><br/><br/><br/>
                            </p>
