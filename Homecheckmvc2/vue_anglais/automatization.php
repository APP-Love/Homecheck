        ...
        <Section>
            <div id="box"> 
                ...
                <div class="box3">
                        ...
                        <form method="post" action="index2.php??cible=action">
                        <p>
                        ...
                        <form class="table2" method="post" action="index2.php?cible=piece" >
                        ...
                        <form class="table2" method="post" action="index2.php?cible=recurrence" >
