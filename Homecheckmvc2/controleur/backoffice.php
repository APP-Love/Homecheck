...
if(isset($_GET['cible']) && $_GET['cible']=="verif"){                                   // L'utilisateur vient de valider le formulaire de connexion
    if(!empty($_POST['identifiant']) && (!empty($_POST['mdp']))){                      // L'utilisateur a rempli tous les champs du formulaire
       ...
       if($_POST['mdp']  == $max_row['mdp'] && $_POST['identifiant']== "administrateur@isep.fr"){                   // si mdp et identifiant bon 
        ...
        else if($_POST['mdp'] == $max_row['mdp'] AND $_POST['identifiant'] != "administrateur@isep.fr"){                   // si mdp et identifiant bon 
