            ...
            <form method="post" action="index.php?cible=edit">
                ...
                <table class="modifier">
                    ...
                    <tr>
                        ...
                        <td class="td3"><input type="text" name="newville" id="ville" placeholder= <?php echo ($_SESSION['ville']); ?> /></td>
                    </tr>
                 </table>
                    <br/>
                    <br/>
